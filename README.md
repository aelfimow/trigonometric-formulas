...
See also [trigonometric-formulas-arm64](https://github.com/aelfimow/trigonometric-formulas-arm64) using Visual Studio 2026 for ARM64.
...
```
* [Formula 68](./formulas/formula68/README.md)
```math
\sin{\alpha} + \sin{\beta} = 2 \sin{\frac{\alpha + \beta}{2}} \cos{\frac{\alpha - \beta}{2}}
```
* [Formula 69](./formulas/formula69/README.md)
```math
...
```
* [Formula 71](./formulas/formula71/README.md)
```math
...
```
* [Formula 73](./formulas/formula73/README.md)
```math
\tan{\alpha} - \tan{\beta} = \frac{\sin{(\alpha - \beta)}}{\cos{\alpha}\cos{\beta}}
```
* [Formula 74](./formulas/formula74/README.md)
```math
...
```
* [Formula 77](./formulas/formula77/README.md)
```math
...
\cos{\alpha} - \sin{\alpha} = \sqrt{2} \cos{(45^\circ + \alpha)}
```
* [Formula 81](./formulas/formula81/README.md)
```math
\sqrt{2} \sin{(45^\circ - \alpha)} = \sqrt{2} \cos{(45^\circ + \alpha)}
```
...
```
* [Formula 83](./formulas/formula83/README.md)
```math
...
```
* [Formula 85](./formulas/formula85/README.md)
```math
...
\tan{\alpha} \tan{\beta} = -\frac{\tan{\alpha} - \tan{\beta}}{\cot{\alpha} - \cot{\beta}}
```
* [Formula 88](./formulas/formula88/README.md)
```math
...
\cot{\alpha} \cot{\beta} = -\frac{\cot{\alpha} - \cot{\beta}}{\tan{\alpha} - \tan{\beta}}
```
* [Formula 90](./formulas/formula90/README.md)
```math
...
\tan{\alpha} \cot{\beta} = -\frac{\tan{\alpha} - \cot{\beta}}{\cot{\alpha} - \tan{\beta}}
```
* [Formula 92](./formulas/formula92/README.md)
```math
\cot{\alpha} \tan{\beta} = \frac{\cot{\alpha} + \tan{\beta}}{\tan{\alpha} + \cot{\beta}}
```
* [Formula 93](./formulas/formula93/README.md)
```math
\cot{\alpha} \tan{\beta} = -\frac{\cot{\alpha} - \tan{\beta}}{\tan{\alpha} - \cot{\beta}}
```
...
```
* [Formula 95](./formulas/formula95/README.md)
```math
...
```
* [Formula 96](./formulas/formula96/README.md)
```math
...
```
* [Formula 100](./formulas/formula100/README.md)
```math
